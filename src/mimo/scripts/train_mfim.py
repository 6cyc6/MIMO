...
model = VNNMIMOShared(latent_dim=256, o_dim=opt.o_dim).cuda()
...
loss_fn = val_loss_fn = losses.mfim_loss

training.train_mfim(model=model_parallel, train_dataloader=train_dataloader, val_dataloader=val_dataloader,
