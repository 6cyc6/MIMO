...
from mimo.model.vnn_occ_net import VNNScfNet
...
model = VNNScfNet(latent_dim=256, sigmoid=True).cuda()
...
training.train_scf(model=model_parallel, train_dataloader=train_dataloader, val_dataloader=val_dataloader,
