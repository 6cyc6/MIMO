...
# placement of table (urdf)
_C.TABLE_POS_URDF = [0.5, 0.0, 0.4]
_C.TABLE_SCALING_URDF = 0.9
_C.TABLE_Z_URDF = 1.15

# placement of table (obj)
_C.TABLE_POS = [0.5, 0.0, 0.0]
_C.TABLE_ORI = [0.0, 0.0, 0.7071067811865475, 0.7071067811865476]
_C.TABLE_SCALING = [1.0, 1.0, 1.0]
_C.TABLE_Z = 1.2
_C.TABLE_MESH_FILE = 'hanging/table/simple_table_large.obj'

# placement objects (shelf and rack)
...
_C.OPTIMIZER = CN()
_C.OPTIMIZER.SHAPE_PCD_PTS_N = 1500
_C.OPTIMIZER.QUERY_PCD_PTS_N = 500
